...
struct s5k4e1gx_i2c_reg_conf s5k4e1_mipi_settings[] =
{
...
/* PLL Configuration */
struct s5k4e1gx_i2c_reg_conf s5k4e1_pll_preview_settings[] =
{
    {0x0305, 0x04},
    {0x0306, 0x00},
    {0x0307, 0x44},
...
struct s5k4e1gx_i2c_reg_conf s5k4e1_pll_snap_settings[] =
{
    {0x0305, 0x04},
    {0x0306, 0x00},
    {0x0307, 0x44},
...
struct s5k4e1gx_i2c_reg_conf s5k4e1_prev_settings[] =
{
...
struct s5k4e1gx_i2c_reg_conf s5k4e1_snap_settings[] =
{
...
struct s5k4e1gx_i2c_reg_conf s5k4e1_recommend_settings[] =
{
    /*CDS timing setting ... */
    {0x3000, 0x05},
    {0x3001, 0x03},
