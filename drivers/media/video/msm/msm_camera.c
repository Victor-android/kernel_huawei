	...
	unsigned long arg)
{
	...
	case MSM_CAM_IOCTL_FLASH_CTRL: {
		...
		/*< DTS2011091402372   yuguangcai 20110914 begin */
		{
            ...
            /* <DTS2011093002017 zhangbo 20110930 begin */
            ...
            /* DTS2011093002017 zhangbo 20110930 end> */
			{
			...
			int is_controlnode)
{
	...
	if (!sync->core_powered_on && !is_controlnode) {
		...
		if (sync->vfefn.vfe_init) {
			...
			if (rc < 0) {
				/* < DTS2011082505806 zhangyu 20110831 begin */
				/* Comeback and remove modify by DTS2010101100541 and DTS2011082505806 */
				pr_err("%s: sensor init failed: %d\n",
					__func__, rc);

				/* DTS2011082505806 zhangyu 20110831 end > */ 
				msm_camio_sensor_clk_off(sync->pdev);
				goto msm_open_done;
			}
