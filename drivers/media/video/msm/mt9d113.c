...
/*< DTS7X27CAMERA0011109 zhangyu 20101109 begin*/
#include <linux/slab.h>
/*DTS7X27CAMERA0011109 zhangyu 20101109 end >*/
#include "mt9d113.h"

/* <DTS2010080300860 liuyuntao 20100820 begin */
#include "linux/hardware_self_adapt.h"
/* DTS2010080300860 liuyuntao 20100820 end> */
...
/*<BU5D01416 zhangsheng 20100128 begin*/
typedef enum
{
...
/*BU5D01416 zhangsheng 20100128 end>*/
...
static struct mt9d113_i2c_reg_conf mt9d113_init_reg_config_comm[] =
{
    ...
    {0x098C, 0x271F},
    {0x0990, 0x0293},
	/*< DTS2011070403865   songxiaoming 20110704 begin */
    {0x098C, 0x272D},
    /*<DTS2011061600439 renzhanmin 20110728 begin */
    {0x0990, 0x0027},//capture mirror data, low 2 bits
    /* DTS2011061600439 renzhanmin 20110728 end>*/
    {0x098C, 0x2717},
    /*<DTS2011061600439 renzhanmin 20110728 begin */
    {0x0990, 0x046F},//preview mirror data, low 2 bits
    /* DTS2011061600439 renzhanmin 20110728 end>*/
    /*< DTS2011050701164  penghai 20110507 begin */          
    //{0x098C, 0x272D},//capture mirror addr
    //{0x0990, 0x0025},//capture mirror data, low 2 bits
    //{0x098C, 0x2717},//preview mirror addr
    //{0x0990, 0x046D},//preview mirror data, low 2 bits
	/* DTS2011050701164  penghai 20110507 end > */  
	/* DTS2011070403865   songxiaoming 20110704 end > */
    {0x098C, 0xA768},
    {0x0990, 0x0006},
...
/*<BU5D04446 zhangsheng 20100308 begin*/
    {0x098C, 0x2755},
    {0x0990, 0x0200},    
    {0x098C, 0x2757},
    {0x0990, 0x0200},    
    {0x098C, 0xa103},
    {0x0990, 0x0005},   
/*BU5D04446 zhangsheng 20100308 end>*/	  
};
...
/*<BU5D01124 zhangsheng 20100126 begin*/
...
{   
    /*< DTS2011090905840   songxiaoming 20110917 begin */
    {0x098C, 0x2763},
    {0x0990, 0x28CA},
    ...
    {0x098C, 0xA103},
    {0x0990, 0x0006},
    /* DTS2011090905840   songxiaoming 20110917 end > */
};
/*BU5D01124 zhangsheng 20100126 end>*/
...
static int32_t mt9d113_i2c_write_w(unsigned short waddr, unsigned short wdata)
{
	int32_t rc = -EFAULT;
	unsigned char buf[4];
	/* < DTS2010080202653 zhangyu 20100802 BEGIN*/
	int32_t i = 0;
	/* DTS2010080202653 zhangyu 20100802 END > */ 
...
/*<BU5D07223 zhangsheng 20100426 begin*/
int32_t mt9d113_board_set_exposure_mode(void)
{
    int32_t rc = 0;
    /*< DTS2011011301655 zhanghua 20110113 begin*/
    if( 1)//machine_is_msm7x27_u8650() )
    /* DTS2011011301655 zhanghua 20110113 end>*/
    {
        /*large exposure*/
...
/*BU5D07223 zhangsheng 20100426 end>*/
...
{
	long rc = 0;
/*<BU7D00454 zhangsheng 20100317 begin*/
...
/*BU7D00454 zhangsheng 20100317 end>*/
...
/*BU7D00454 zhangsheng 20100317 end>*/
    /* < DTS2010052000108 yangjianguang 20100521 begin */
    /* for color distortion;this reg val sometimes error */
	mt9d113_mode_id = mt9d113_mode_id & 0x03;
    /* DTS2010052000108 yangjianguang 20100521 end > */
...
{
/*<BU5D02611 zhangsheng 20100222 begin*/
/*<BU5D07844 zhangsheng 20100415 begin*/
    gpio_direction_output(data->sensor_reset, 0);
/*BU5D07844 zhangsheng 20100415 end>*/
    gpio_free(data->sensor_reset);

	/*< DTS2010082403657  zhangxiangdang 20100825 begin */
	/*delete BU5D09920,power on camera can reduce i2c error. */
	gpio_direction_output(data->sensor_pwd, 1);
	gpio_free(data->sensor_pwd);
	mdelay(100);
	/* DTS2010082403657 zhangxiangdang 20100825 end > */
/*BU5D02611 zhangsheng 20100222 end>*/	
...
static int mt9d113_probe_init_sensor(const struct msm_camera_sensor_info *data)
{
   ...
   // if(data->master_init_control_slave == NULL 
	...
	/*< DTS2011031402847 penghai 20110314 begin */
	...
	/* DTS2011031402847 penghai 20110314 end >*/
/*<BU7D00454 zhangsheng 20100317 begin*/
#if 0
    if(mt9d113_i2c_read_w(0x31FE, &mt9d113_version_id) <0)
    {
		...
		struct msm_sensor_ctrl *s)
{
	...
	if (rc < 0) {
		...
		CDBG("camera sensor mt9d113 probe is failed!!!\n");
		goto probe_done;
	}
	...
	{
		CDBG("camera sensor mt9d113 probe is succeed!!!\n");
	}
	/* DTS2011011301655 zhanghua 20110113 end>*/
