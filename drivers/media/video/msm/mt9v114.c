...
static struct mt9v114_i2c_reg_conf mt9v114_init_reg_config[] =
{
    ...
    /*< DTS2011101403310   songxiaoming 20111014 begin */ 
    // AWB-CCM
    ...
    /* DTS2011101403310   songxiaoming 20111014 end > */
    // Step 7
...
/*< DTS2011061606330   songxiaoming 20110819 begin */
...
/* DTS2011061606330   songxiaoming 20110819 end > */
...
int mt9v114_sensor_config(void __user *argp)
{
    ...
    case CFG_SET_EFFECT:
		/*< DTS2011081400458   songxiaoming 20110815 begin */
		/*< DTS2011072504793   songxiaoming 20110803 begin */
        /* < DTS2011081806427 zhangyu 20110818 begin */
    ...
    case CFG_SET_WB:
    	/*< DTS2011081601555   yuguangcai 20110816 begin */
    	/*turn on the whitebalance setting*/
        rc = mt9v114_set_wb(
            cdata.cfg.effect);
        /* DTS2011081601555   yuguangcai 20110816 end > */    
        break;
		/* DTS2011072504793   songxiaoming 20110803 end > */
		/* DTS2011081400458   songxiaoming 20110815 end > */
    default:
        rc = -EFAULT;
        break;
    }
                                ...
                                struct msm_sensor_ctrl *s)
{
    ...
    /*<DTS2011072502426 zhudengkui 20110822 begin */
    s->s_mount_angle = 180;
    /* DTS2011072502426 zhudengkui 20110822 end>*/
