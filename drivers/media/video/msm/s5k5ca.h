...
struct s5k5ca_reg
{
    ...
    const struct s5k5ca_i2c_reg_conf * s5k5ca_effect_whiteboard_reg_config;
    const unsigned short               s5k5ca_effect_whiteboard_reg_config_size;
    const struct s5k5ca_i2c_reg_conf * s5k5ca_effect_blackboard_reg_config;
    const unsigned short               s5k5ca_effect_blackboard_reg_config_size;
    ...
    const struct s5k5ca_i2c_reg_conf * s5k5ca_antibanding_off_reg_config;
    const unsigned short               s5k5ca_antibanding_off_reg_config_size;
    const struct s5k5ca_i2c_reg_conf * s5k5ca_antibanding_auto_reg_config;
    const unsigned short               s5k5ca_antibanding_auto_reg_config_size;
    const struct s5k5ca_i2c_reg_conf * s5k5ca_antibanding_50hz_reg_config;
    const unsigned short               s5k5ca_antibanding_50hz_reg_config_size;
    const struct s5k5ca_i2c_reg_conf * s5k5ca_antibanding_60hz_reg_config;
    const unsigned short               s5k5ca_antibanding_60hz_reg_config_size;
};
